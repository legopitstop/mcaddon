...
blk.add_component(GeometryComponent("geometry.full_cube", culling="test:sushi_cull"))
...
blk.add_component(QueuedTickingComponent(Range(60, 60), Trigger("queued_ticking")))
