__all__ = ["EntityTimerFlag2Component"]
...
class EntityTimerFlag2Component(EntityBehaviorComponent):
    """
    [Info](https://learn.microsoft.com/en-us/minecraft/creator/reference/content/entityreference/examples/entitygoals/minecraftbehavior_timer_flag_2)
    """

    COMPONENT_ID: ClassVar[str] = "minecraft:behavior.timer_flag_2"
