...
class EntityTemptComponent(EntityBehaviorComponent):
    """
    [Info](https://learn.microsoft.com/en-us/minecraft/creator/reference/content/entityreference/examples/entitygoals/minecraftbehavior_tempt)
    """

    COMPONENT_ID: ClassVar[str] = "minecraft:behavior.tempt"
